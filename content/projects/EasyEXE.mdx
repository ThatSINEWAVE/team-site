---
title: "EasyEXE"
description: EasyEXE is a simple python script based on the pyinstaller library that I made to convert my python scripts to exe files easier.
repository: ThatSINEWAVE/EasyEXE
date: "2024-01-05"
published: true
---
