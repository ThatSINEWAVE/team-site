---
title: "LinkWarden"
description: A bot that uses various APIs to scan links directly inside any discord server automatically
repository: ThatSINEWAVE/LinkWarden-Bot
date: "2024-02-19"
published: true
---

This Discord bot is designed for personal and community use, enhances server security by scrutinizing links shared within Discord channels. It leverages the VirusTotal API, WHOIS lookups, and urlscan.io scans to provide comprehensive real-time analysis, helping maintain a safe online environment for members.
