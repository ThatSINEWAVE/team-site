---
title: "IP Lookup"
description: This is a simple bot that uses IP-API to check and output a nicely formatted message directly in Discord
repository: ThatSINEWAVE/IP-Lookup-Bot
date: "2024-04-03"
published: true
---
